          ...
          <div className="profile-header">
            <div className="position-relative">
              ...
              <div
                ...
                style={{ bottom: "-1rem" }}
              >
                {this.state.qstatus == 1 ? (
                  <AskQuestion hallidquestion={this.props.hallid} />
                ) : null}
                {this.state.pollstatus == 1 ? (
                  <Polls hallidpolls={this.props.hallid} />
                ) : null}
                {this.state.astatus == 1 ? (
                  <AttendeeList hallidattendee={this.props.hallid} />
                ) : null}
                {this.state.agendastatus == 1 ? (
                  <Agenda hallidagenda={this.props.hallid} />
                ) : null}
              </div>
            </div>
          </div>
