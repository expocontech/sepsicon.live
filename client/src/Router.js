...
const addregistration = lazy(() =>
  import("./views/forms/formik/AddRegistration")
);
const registrationlist = lazy(() =>
  import("./views/tables/data-tables/Registration")
);
const registrationlist1 = lazy(() =>
  import("./views/tables/data-tables/Registration1")
);
const scientificlobby = lazy(() =>
  import("./views/pages/scientificlobby/Index")
);
const exhibitionlobby = lazy(() =>
  import("./views/pages/exhibitionlobby/Index")
);
const exhibitionstall = lazy(() =>
  import("./views/pages/exhibitionstall/Index")
);
const sponsor = lazy(() => import("./views/pages/sponsor/Sponsor"));
const sponsordetails = lazy(() =>
  import("./views/pages/sponsor-details/SponsorDetails")
);
...
const leaderboard = lazy(() => import("./views/pages/leaderboard/Leaderboard"));
const meetingplanner = lazy(() =>
  import("./views/pages/meetingplanner/Meetingplanner")
);
const quiz = lazy(() => import("./views/pages/quiz/Index"));
const infodisk = lazy(() => import("./views/pages/infodisk/Index"));
const upcomingevents = lazy(() =>
  import("./views/pages/upcomingevents/Upcomingevents")
);
...
const downloadCertificate = lazy(() =>
  import("./views/pages/download-certificate/index")
);
...
class AppRouter extends React.Component {
  handleLogout = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_BASENAME}logout/${sessionStorage.getItem(
          "email"
        )}`,
        data
      )
  ...
  render() {
    return (
      ...
      <Router history={history}>
        <Switch>
          <AppRoute
            path="/pages/downloadcertificate"
            component={downloadCertificate}
          />
          <AppRoute path="/pages/photoBooth" component={photoBooth} />
          <AppRoute path="/pages/chatRoom" component={chatRoom} />
          ...
          <AppRoute
            path="/pages/scientificlobby"
            component={scientificlobby}
            exact
          />
          <AppRoute
            path="/pages/exhibitionlobby"
            component={exhibitionlobby}
            exact
          />
          <AppRoute
            path="/pages/exhibitionstall"
            component={exhibitionstall}
            exact
          />
          <AppRoute
            path="/pages/exhibitionstall/:ex_hallid"
            component={exhibitionstall}
            exact
          />
          ...
          <AppRoute
            path="/tables/registration1"
            component={registrationlist1}
          />
          ...
          <AppRoute path="/pages/leaderboard" component={leaderboard} exact />
          <AppRoute path="/pages/meetings" component={meetingplanner} exact />
          <AppRoute path="/pages/quiz" component={quiz} exact />
          <AppRoute path="/pages/infodisk" component={infodisk} exact />
          <AppRoute
            path="/pages/upcomingevents"
          ...
          <AppRoute
            path="/pages/scientifichall/:id"
            component={scientifichall1}
            exact
          />
